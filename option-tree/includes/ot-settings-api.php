          ...
          if ( ! isset( $page['hidden_page'] ) && $screen->id == $this->page_hook[$page['id']] ) {
            ...
            if ( $show_buttons ) {
              ...
              echo '<div id="option-tree-settings-api">';
				...
				//echo '<span class="option-tree-ui-button button button-primary grey right imgok1"><a href="#"></a></span>';
				...
				//echo '<span class="option-tree-ui-button button button-primary grey right imgok2"><a href="#"></a></span>';
